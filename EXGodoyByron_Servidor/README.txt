...
a persistence unit "EXGodoyByron_ServidorPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/EXGodoyByron_Servidor/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "EXGodoyByron_Servidor/pom.xml":
...
artifact ("EXGodoyByron_Servidor.war") is already built. You can build
